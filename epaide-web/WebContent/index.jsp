...
<table>
	<tbody>
		<tr>
			<td><a href="#"><img src="images/logo.png" alt="竞拍" border="0" /></a></td>
			<td align="right" width="820">
			<div id="quick_links">
			<ul >
				<li class="mylog">
					<a href="http://${site}/login">登录</a> -
					<a href="http://${site }/register">注册</a>
				</li>
				<li class="myunlog">
					<a href="http://${site}/help?p=novice&amp;id=0">竞拍规则</a>
				</li>
				<li class="myunlog">
					<a href="http://${site}/help?p=tips&amp;id=0">心得与窍门</a>
				</li>
				<li class="myunlog">
					<a href="http://${site}/page/about">易拍得介绍</a>
				</li>
				<li class="myunlog">
					<a href="http://${site}/page/partners">商业合作</a>
				</li>
				<li class="myunlog">
					<a href="http://${site}/contact">我有问题</a>
				</li>
			</ul>
			</div>
			</td>
