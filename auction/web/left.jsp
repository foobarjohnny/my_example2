...
<table width="179" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td width="169" height="40" align="center" valign="top"
			bgcolor="#FFFFFF">
			<s:select list="sortDataList" listKey="id" listValue="sortname" headerKey="" headerValue="按类别查找商品"></s:select>
		</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="5">
						...
						<table>
							...
							<tr>
								<td align="center">
									...
									<a href="userlogin.htm"><img src="images/zc.gif" width="41" height="22" border="0"> 
									</a>
								</td>
							</tr>
						</table>
				...
				<tr>
					<td height="25" align="center">
						...
						<a href="http://www.jiathis.com/share.html" class="jiathis">
							<img src="http://www.jiathis.com/code/images/jiathis2.gif" width="125" height="21" border="0" id="jiathis_a" /> </a>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
				<s:iterator id="help" value="helpDataList">
					<tr>
						<td>
							<img src="images/dian.gif" width="5" height="5">
							<a href="infoView.action?model.nettype=3&model.id=${help.id}">${help.title }</a>
						</td>
					</tr>
				</s:iterator>
				<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
				<s:iterator id="bing" value="bingcurDataList">
					<tr>
						...
						<td width="67%">
							<a href="bingcurForward.action?model.id=${bing.id}">${bing.user}以${bing.price }元竞拍下${bing.comityName }商品</a>
						</td>
					</tr>
				</s:iterator>
				<tr>
