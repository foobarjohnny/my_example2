...
<html>
	...
	<body>
		...
		<hr>
		<s:form action="doohickeyList.action" name="form1">
			...
			<table width="100%" border="1" cellpadding="10" cellspacing="0"
				...
				<s:iterator value="dataList" id="data" status="status">
					<tr>
						...
						<td align="center">
							<a href="doohickeyView.action?id=<s:property value="id"/>">详细内容</a>|
							<a href="doohickeyDelete.action?id=<s:property value="id"/>">删除</a>
						</td>
					</tr>
				</s:iterator>
				<tr align="right">
