						...
						<tr>
							<td>
								<form method="post" name="help" action="searchUserPayE.action">
									...
									<tr>
						              <td width="20%" align="center" bgcolor="#E8E8E8" class="admin_title2"><strong>商品描述</strong></td>
					                  <td width="41%" align="center" bgcolor="#E8E8E8" class="admin_title2"><strong>价格</strong></td>
									...
									<s:iterator value="dataList" id="data" status="status">
							          <tr>
						                  <td align="center">${data.comname }${data.descript }</td>
						                  <td align="center"><SPAN class="indexjg" >￥${data.price}</SPAN><BR>
                  							市场价 ￥${data.markPrice}</td>
