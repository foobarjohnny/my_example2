...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function insert() {
				form1.action = "infoForward.action";
				form1.submit();
			}
		</script>
	</head>
	<body>
		...
		<s:form action="infoSearch.action" name="form1">
			...
			<table width="100%" border="1" cellpadding="10" cellspacing="0"
				...
				<tr>
					<td colspan="7">
						<input type="button" name="Submit2" value="发布公告" onclick="insert()"/>
					</td>
				</tr>
				<tr>
				...
				<s:iterator value="dataList" id="data" status="status">
					<tr>
						...
						<td align="center">
							<a href="infoForward.action?id=<s:property value="id"/>&nettype=5">修改</a>｜
							<a href="infoDelete.action?id=<s:property value="id"/>&nettype=5">删除</a>
						</td>
					</tr>
				</s:iterator>
				<tr align="right">
