...
public class JmxCollectorMain {
    ...
    // logger
    private static final Log _logger = LogFactory.getLog(JmxCollectorMain.class);
    private final static String ERROR = "40";
    private final static String WARNING = "30";
    private final static String INFO = "20";
    private final static String DEBUG = "10";
    private static final HashMap<String, Level> loggingLevel = new HashMap<String, Level>();
    ...
    public static void main(String[] args) throws ParseException {
        ...
        try {
            ...
            _logger.fatal("Server start failed " + ex.getMessage());
        }
    }
