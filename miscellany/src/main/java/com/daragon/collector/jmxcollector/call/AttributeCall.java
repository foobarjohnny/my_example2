...
import com.daragon.collector.jmxcollector.ConfigAdapter;
import com.daragon.collector.jmxcollector.JmxClient;
import com.daragon.collector.jmxcollector.JmxException;
 ...
 */
public class AttributeCall extends JmxCall {
    ...
    // logger
    private static final Log _logger = LogFactory.getLog(AttributeCall.class);
